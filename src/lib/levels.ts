...
export const LEVELS: Level[] = [
  ...
  },
  {
    ...
    goalRadius: 44,
    budget: 1100,
    hint: "Two pegs block the way. Drop a line through the narrow gap between them.",
    lines: [
      { x1: 150, y1: 205, x2: 300, y2: 245, type: "normal", fixed: true },
      { x1: 600, y1: 380, x2: 640, y2: 560, type: "normal", fixed: true },
      { x1: 760, y1: 380, x2: 800, y2: 560, type: "normal", fixed: true },
      { x1: 1060, y1: 760, x2: 1280, y2: 760, type: "normal", fixed: true },
    ],
  },
  {
    id: 15,
    ...
    goalRadius: 46,
    budget: 900,
    hint: "Chain boost lines like a ramp to launch up to the high platform.",
    lines: [
      { x1: 150, y1: 730, x2: 320, y2: 760, type: "normal", fixed: true },
      { x1: 1040, y1: 200, x2: 1280, y2: 200, type: "normal", fixed: true },
      { x1: 600, y1: 460, x2: 660, y2: 420, type: "normal", fixed: true },
    ],
  },
  {
    id: 16,
    ...
    goalRadius: 46,
    budget: 2400,
    hint: "Build up speed, then draw a loop. The rider will ride the inside of it.",
    lines: [
      { x1: 150, y1: 205, x2: 300, y2: 245, type: "normal", fixed: true },
      { x1: 1060, y1: 800, x2: 1280, y2: 800, type: "normal", fixed: true },
    ],
  },
];
